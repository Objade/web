...
public class Ex03 {
	public static void main(String[] args) {
		...
		int index1 = s1.indexOf("el");	// s1에서 "el" 이라는 글자는 몇번째에 있는가?
		System.out.println(index1);
		
		int index2 = "ABCDEFG".indexOf("FG");	// "ABCDEFG" 에서 "FG" 이라는 글자는 몇번째에 있는가?
		System.out.println(index2); // 5 -> AB, BC, CD, DE, EF, FG
									//		0	1	2	3	4	5
