...
public class Ex03 {
	public static void main(String[] args) {
		...
		// map[key] 형식으로 접근한다.
		// 단, 배열처럼 쓰지는 않고, 함수를 이용하여 값에 접근한다.
		...
		// key와 value가 1대1로 mapping하는 구조이기 때문에, map이라고 부름
		
		// 단, key와 value는 양방향 mapping이 아님
		// ~ key -> value (o)
		// ~ value -> key (x)
		...
		// 4) EntrySet
		for(Entry<String, Object> entry : map.entrySet()) {		// Entry는 하나, map은 묶음
