...
public class Ex01 {
	public static void main(String[] args) {
		...
		// - 서로 다른 자료형의 데이터를 묶어서 저장하려면 새로운 자료형을 정의해야 함.
		//	1) 구조체 (C언어)		: 변수만 묶어서 자료형을 만든다.
		//  2) 클래스 (Java, C++)	: 변수와 함수를 묶어서 자료형을 만든다.
		...
		// false가 나오는 이유
		// - 서로가 바라보는 대상(참조대상)이 다르기 때문임
		// - str1 : 입력을 받기 위해 준비한 공간
		// - str2 : 내가 준비한 값
		// - str3 : new 를 사용하여 새로운 공간을 만들어 참조하라고 한 대상
		// - str2와 str4은 따로 참조를 지시하지 않았음 -> 서로 같은 곳을 참조. (True)
