...
public class Ex03 {
	public static void main(String[] args) throws ParseException {
		...
		// 컴퓨터는 1970년 1월 1일 0시 0분 0초을 기준으로 지난 시간을 초단위로 계산함
		// 자바에서는 1초 대신 1/1000 초(millisecond)로 기록함
		...
		String s1 = sdf.format(today);	// today를 위의 형식에 맞춰 문자열로 변환
