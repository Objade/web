...
public class EnglishLiguisticStudent extends Student {
	
	private int literature;		// 문학(영문학)
	private int translation;	// 번역
	
	
	public EnglishLiguisticStudent(String name, int kor, int eng, int mat, int literature, int translation) {
	...
	public void showInfo() {
		System.out.printf("[영어 영문학] 이름 : %s, 합계 : %d, 평균 : %.2f\n", name, sum, avg);
	...
	public void showDetail() {
		System.out.println("[영어 영문학] " + name);
